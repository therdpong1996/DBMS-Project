...
## ESP8266
**อุปกรณ์**
1. บอร์ด ESP-8266     (โมดูล WiFi ที่มีความพิเศษตรงที่สามารถเขียนโปรแกรมลงไปได้)
2. เซ็นเซอร์ DHT22     (เซนเซอร์วัด อุณหภูมิ+ความชื้น)
3. สายไฟ            (ใช้เชื่อมต่ออุปกรณ์)
4. มิเตอร์แบบสั่น       (แจ้งเตือนโดยการสั่น)
