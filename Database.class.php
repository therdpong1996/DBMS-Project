...
class Database {
    ...
    public function loopdatabase($action, $n = 20, $data){
        ...
        }elseif ($action == 'mistake') {
            echo $sql_m = "INSERT INTO mistake(success,error,time) VALUES ('".$data["success"]."', '".$data["error"]."', '".time()."')";
            $save_m = mysqli_query($con, $sql_m);
            mysqli_close($con);
        }
